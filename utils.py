...
def draw_complex_spectrum(signal1name, signal2name, machine_type, bg, title, savefig=True, fileformat = '.jpg', abs_path = './processed_data'):
    ...
    plt.title(signal1name.split('/')[-1].split('_')[1]+' (real)', fontsize=40)
    ...
    plt.title(signal2name.split('/')[-1].split('_')[1]+' (real)', fontsize=40)
    ...
    plt.title(signal1name.split('/')[-1].split('_')[1]+' (imaginary)', fontsize=40)
    ...
    plt.title(signal2name.split('/')[-1].split('_')[1]+' (imaginary)', fontsize=40)
